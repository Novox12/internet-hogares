function setPlanTypeValue(value) {
                            ...
                            <form action="../backend/helper.php" enctype="multipart/form-data" method="POST" onsubmit="return validateModalFields('${targets[i]}-input-name', '${targets[i]}-input-phone');">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group" style="display: none;">
                                            <input class="form-control form-input" type="text" name="type_form_lead" id="planType" readonly>
                                        </div>
                                        <div class="form-group" style="display: none;">
                                            <input class="form-control form-input" type="text" name="segment_lead" value="full_tigo" readonly>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="submit" onClick="submitIdModal('${targets[i]}')" class="btn btn-warning btn-modal w-100 ${targets[i]}-class" id="${targets[i]}-btn btn-modal-send">ESTOY INTERESADO</button>
                                    </div>
                                </div>
                            </form>
                        </div>
